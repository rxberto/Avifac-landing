        ...
        <section className="bg-[#151816] dark:bg-[#111315] border border-[#303131] rounded-[8px] p-8 sm:p-12 lg:p-14 text-center text-white relative overflow-hidden shadow-2xl">
          <div className="max-w-3xl mx-auto space-y-6 relative z-10">
            ...
            <p className="text-xs sm:text-sm lg:text-base text-white/70 leading-relaxed">
              {t(
                'Prueba el escáner OCR con Inteligencia Artificial durante 30 días completamente gratis. Sin tarjeta de crédito ni compromiso de permanencia.',
                'Test our AI-driven OCR receipt scanner for 30 days completely free. No credit card required and zero binding commitments.'
              )}
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-2">
              ...
              >
                <Zap className="size-5 fill-current shrink-0" />
                <span>{t('Activar Escáner OCR (30 días gratis)', 'Activate OCR Scanner (30 days free)')}</span>
