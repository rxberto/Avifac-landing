        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-y-12 mb-16">
          ...
          <div className="md:col-span-2 space-y-3.5 text-left">
            ...
            <ul className="space-y-2.5">
              ...
              <li><FooterLink href="/sobre-nosotros">{t('Sobre Nosotros', 'About Us')}</FooterLink></li>
              <li><FooterLink href="https://avialo.tech" external target="_blank" rel="noopener noreferrer">{t('Transformación Digital ↗', 'Digital Transformation ↗')}</FooterLink></li>
          ...
          <div className="md:col-span-2 space-y-3.5 text-left">
            ...
            <ul className="space-y-2.5">
              ...
              <li><FooterLink href="https://avialo.tech" external target="_blank" rel="noopener noreferrer">{t('Transformación Digital & Desarrollo a Medida ↗', 'Digital Transformation & Custom Dev ↗')}</FooterLink></li>
